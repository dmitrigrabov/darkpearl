...
var require_identifier = __commonJS({
  "../../../../Library/Caches/deno/npm/registry.npmjs.org/@babel/helper-validator-identifier/7.27.1/lib/identifier.js"(exports) {
    ...
    exports.isIdentifierName = isIdentifierName7;
    ...
    function isIdentifierName7(name) {
      let isFirst = true;
...
// deno:https://jsr.io/@skmtc/core/0.0.984/dsl/Import.ts
var Import = class {
   ...
   */
  toString() {
    const importAllAs = this.importNames.find((importName) => importName.toString().startsWith("* as "));
    const importNames = this.importNames.filter((importName) => !importName.toString().startsWith("* as "));
    const importObject = importNames.length > 0 || !importAllAs ? List.toObject(importNames) : void 0;
    const importItems = new List([
      importAllAs,
      importObject
    ], {
      separator: ", ",
...
// deno:https://jsr.io/@skmtc/core/0.0.984/dsl/ContentBase.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/typescript/withDescription.ts
var withDescription = (value, { description }) => {
  return description ? `/** ${description} */
${value}` : `${value}`;
};

// deno:https://jsr.io/@skmtc/core/0.0.984/dsl/Definition.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/types/Method.ts
var methodValues = [
  "get",
  "put",
  "post",
...
// deno:https://jsr.io/@skmtc/core/0.0.984/dsl/GeneratorKeys.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/dsl/operation/OperationDriver.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/dsl/model/ModelDriver.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/dsl/ContentSettings.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/dsl/Inserted.ts
var Inserted = class {
...
// deno:https://jsr.io/@skmtc/core/0.0.984/dsl/File.ts
var File2 = class {
...
// deno:https://jsr.io/@skmtc/core/0.0.984/dsl/JsonFile.ts
var JsonFile = class {
...
// deno:https://jsr.io/@skmtc/core/0.0.984/context/GenerateContext.ts
var GenerateContext = class {
  ...
  toArtifacts(stackTrail) {
    ...
    generators.forEach((generatorConfig) => {
      stackTrail.trace(generatorConfig.id, (st) => {
        ...
        const skip3 = this.settings?.skip?.find((skip4) => {
          return typeof skip4 === "object" && Boolean(skip4[generatorConfig.id]);
        });
        switch (generatorConfig.type) {
          case "operation":
            this.#runOperationGenerator(this.oasDocument, generatorConfig, toSkipPaths(skip3, generatorConfig.id), st);
            break;
          case "model":
            this.#runModelGenerator(this.oasDocument, generatorConfig, toSkipModels(skip3, generatorConfig.id), st);
            break;
          default:
  ...
  #runOperationGenerator(oasDocument, generatorConfig, skip3, stackTrail) {
    oasDocument.operations.reduce((acc, operation) => {
      return stackTrail.trace(`${operation.path}:${operation.method}`, (st) => {
        try {
          ...
          if (skip3?.[operation.path]?.includes(operation.method)) {
          ...
          const source3 = toOperationSource({
            operation,
            generatorId: generatorConfig.id
          });
          this.#addPreview(source3, generatorConfig.toPreviewModule?.({
            context: this,
            operation
          }));
          this.#addMapping(source3, generatorConfig.toMappingModule?.({
            context: this,
            operation
          }));
  ...
  #runModelGenerator(oasDocument, generatorConfig, skip3, stackTrail) {
...
var toSkipPaths = (skip3, generatorId) => {
  const generatorSkip = skip3?.[generatorId];
  if (typeof generatorSkip === "object" && !Array.isArray(generatorSkip)) {
    return generatorSkip;
  }
  return void 0;
};
var toSkipModels = (skip3, generatorId) => {
  const generatorSkip = skip3?.[generatorId];
...
// deno:https://jsr.io/@skmtc/core/0.0.984/helpers/toResolvedArtifactPath.ts
var toResolvedArtifactPath = ({ basePath, destinationPath }) => {
  return join3(basePath ?? "./", destinationPath.replace(/^@\//, ""));
};

// deno:https://jsr.io/@skmtc/core/0.0.984/context/RenderContext.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/tag/Tag.ts
var OasTag = class {
  oasType = "tag";
  #fields;
  constructor(fields) {
...
// deno:https://jsr.io/@skmtc/core/0.0.984/helpers/isEmpty.ts
var isEmpty = (value) => {
  return !Object.keys(value).length;
};

// deno:https://jsr.io/@skmtc/core/0.0.984/oas/specificationExtensions/toSpecificationExtensionsV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/tag/toTagsV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/helpers/refFns.ts
var toRefName = ($ref) => {
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/ref/Ref.ts
var MAX_LOOKUPS = 10;
...
var OasRef = class {
  ...
  resolveOnce() {
    ...
    switch (refType) {
      case "schema":
        resolved = c2?.schemas?.[refName];
        break;
      case "requestBody":
        resolved = c2?.requestBodies?.[refName];
        break;
      case "parameter":
        resolved = c2?.parameters?.[refName];
        break;
      case "response":
        resolved = c2?.responses?.[refName];
        break;
      case "example":
        resolved = c2?.examples?.[refName];
        break;
      case "header":
        resolved = c2?.headers?.[refName];
        break;
      case "securityScheme":
        resolved = c2?.securitySchemes?.[refName];
        break;
      default: {
        const _exhaustive = refType;
        throw new Error(`Unhandled ref type: ${_exhaustive}`);
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/ref/toRefV31.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/array/Array.ts
var OasArray = class {
  /**
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_helpers/parseNullable.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_helpers/parseEnum.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/array/array-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/array/toArray.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/object/Object.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/object/toAdditionalPropertiesV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/object/toObject.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/integer/Integer.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/integer/integer-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/integer/toInteger.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/number/Number.ts
var OasNumber = class {
  /**
   * Object is part the 'schema' set which is used
   * to define data types in an OpenAPI document.
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/number/number-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/number/toNumber.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/boolean/Boolean.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/boolean/boolean-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/boolean/toBoolean.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/string/String.ts
var OasString = class {
  /**
   * Object is part the 'schema' set which is used
   * to define data types in an OpenAPI document.
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/string/string-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/string/toString.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/unknown/Unknown.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/unknown/toUnknown.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/union/Union.ts
var OasUnion = class {
  /**
   * Object is part the 'schema' set which is used
   * to define data types in an OpenAPI document.
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/discriminator/Discriminator.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/discriminator/toDiscriminatorV3.ts
var toDiscriminatorV3 = ({ discriminator, stackTrail, context }) => {
  if (!discriminator) {
    return void 0;
  }
  const { propertyName, mapping: mapping3, ...skipped } = discriminator;
  if (!isEmpty(skipped)) {
    context.logSkippedFields({
      skipped,
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/union/toUnion.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/decompose-intersection.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/check-type-conflicts.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/check-read-only-write-only-conflicts.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/check-format-conflicts.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/is-equal.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/check-enum-conflicts.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/check-number-constraints-conflicts.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/check-array-item-type-conflicts.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/merge-enum-values.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/merge-properties.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/merge-required.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/generic-merge.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/merge-object-constraints.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/merge-array-constraints.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/check-at-least-one-type-match.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/merge-string-constraints.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/merge-number-constraints.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/merge-integer-constraints.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/merge-boolean-constraints.ts
function mergeBooleanConstraints(first, second, getRef) {
  checkTypeConflicts(first, second);
  return genericMerge(first, second, getRef, boolean());
}

// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/decompose-union.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/cross-product.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/merge-union.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/nullable-merge.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/merge.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/_merge-all-of/merge-intersection.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/schema/toSchemasV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/example/Example.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/example/toExamplesV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/mediaType/MediaType.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/mediaType/toMediaTypeItemV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/requestBody/RequestBody.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/requestBody/toRequestBodiesV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/header/Header.ts
var OasHeader = class {
  oasType = "header";
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/header/toHeadersV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/response/Response.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/response/toResponseV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/parameter/parameter-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/parameter/Parameter.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/parameter/toParameterV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/operation/Operation.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/pathItem/PathItem.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/pathItem/toPathItemV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/securityRequirement/SecurityRequirement.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/securityRequirement/toSecurityRequirement.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/externalDocs/ExternalDocs.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/markdown/markdown-types.ts
var markdown = string();

// deno:https://jsr.io/@skmtc/core/0.0.984/oas/externalDocs/externalDocsTypes.ts
var oasExternalDocsData = object({
  description: optional(markdown),
  url: string()
});

// deno:https://jsr.io/@skmtc/core/0.0.984/oas/externalDocs/toExternalDocs.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/server/Server.ts
var OasServer = class {
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/serverVariable/ServerVariable.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/serverVariable/toServerVariableV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/server/toServerV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/operation/toOperationsV3.ts
var toOperationV3 = ({ operation, operationInfo, stackTrail, context }) => {
  const { method: method3, path, pathItem } = operationInfo;
  ...
  return Object.entries(paths).flatMap(([path, pathItem]) => {
    return stackTrail.trace(path, (st) => {
      ...
      const cleaned = Object.entries(pathItem).reduce(({ rest, methodObject }, [key, operation]) => {
        const isMethod3 = methodValues.includes(key);
        if (isMethod3) {
      ...
      return Object.entries(cleaned.methodObject).map(([method3, operation]) => {
        return stackTrail.trace(method3, (st2) => {
          if (!operation) {
            return;
          }
          try {
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/components/Components.ts
var componentsKeys = [
  "schemas",
  "responses",
  "parameters",
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/securitySchemes/SecurityScheme.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/securitySchemes/security-scheme-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/securitySchemes/toSecuritySchemes.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/components/toComponentsV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/info/Info.ts
var OasInfo = class {
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/contact/Contact.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/contact/toContactV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/license/License.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/license/toLicenseV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/info/toInfoV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/document/toDocumentFieldsV3.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/document/Document.ts
var OasDocument = class {
  ...
  removeItem(stackTrail) {
    ...
    switch (first) {
      case "paths": {
        const index = this.#fields.operations.findIndex(({ path, method: method3 }) => path === second && method3 === third);
        if (index === -1) {
          return void 0;
        }
...
// deno:https://jsr.io/@skmtc/core/0.0.984/context/ParseContext.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/context/StackTrail.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/context/ResultsHandler.ts
var ResultsHandler = class extends BaseHandler {
  ...
  log(levelName) {
    ...
    this.context.captureCurrentResult(resultType3, new StackTrail([
      "SKIPPED"
    ]));
  }
  /**
...
// deno:https://jsr.io/@skmtc/core/0.0.984/helpers/ResultsLog.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/context/CoreContext.ts
...
function skmtcJsonFormatter({ logRecord, stackTrail }) {
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/contact/contact-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/discriminator/discriminator-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/example/example-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/license/license-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/info/info-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/ref/ref-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/helpers/sanitizePropertyName.ts
var import_helper_validator_identifier_7_27 = __toESM(require_lib());

// deno:https://jsr.io/@skmtc/core/0.0.984/typescript/List.ts
var List = class _List {
  ...
  static fromKeys = (record2) => {
    return new KeyList(Object.keys(record2 ?? {}));
  };
  /**
  ...
  static fromEntries = (record2) => {
    return new EntryList(Object.entries(record2 ?? {}));
  };
  /**
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/tag/tag-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/oas/unknown/unknown-types.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/run/toArtifacts.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/types/DenoJson.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/types/ModuleExport.ts
var moduleExport = object({
  exportName: string(),
  exportPath: string()
});

// deno:https://jsr.io/@skmtc/core/0.0.984/types/Enrichments.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/types/Results.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/types/Preview.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/types/Manifest.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/types/PrettierConfig.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/types/Settings.ts
...
// deno:https://jsr.io/@skmtc/core/0.0.984/typescript/FunctionParameter.ts
var import_helper_validator_identifier_7_272 = __toESM(require_lib());

// deno:https://jsr.io/@skmtc/core/0.0.984/typescript/identifiers.ts
var import_helper_validator_identifier_7_273 = __toESM(require_lib());

// deno:https://jsr.io/@skmtc/worker/0.0.56/mod.ts
var toWorker = (toGeneratorConfigMap) => {
  self.onmessage = async (e2) => {
    ...
    try {
      switch (type) {
        case "GENERATE": {
          const { documentObject, clientSettings: clientSettings3, silent } = payload;
          const now = Date.now();
...
// deno:https://jsr.io/@skmtc/core/0.0.974/dsl/ContentBase.ts
var ContentBase2 = class {
  /** The generation context providing access to OAS objects and utilities */
  context;
  /** Whether this generator has been skipped */
  skipped = false;
...
// deno:https://jsr.io/@skmtc/core/0.0.974/typescript/withDescription.ts
var withDescription2 = (value, { description }) => {
  return description ? `/** ${description} */
${value}` : `${value}`;
};

// deno:https://jsr.io/@skmtc/core/0.0.974/dsl/Definition.ts
var Definition2 = class extends ContentBase2 {
  /** The identifier for this definition */
  identifier;
  /** Optional description for JSDoc comments */
  description;
  ...
  toString() {
    const identifier = this.identifier.typeName ? `${this.identifier.name}: ${this.identifier.typeName}` : this.identifier.name;
    return withDescription2(`${this.noExport ? "" : "export "}${this.identifier.entityType} ${identifier} = ${this.value};
`, {
      description: this.description
    });
  }
...
// deno:https://jsr.io/@skmtc/core/0.0.974/types/Method.ts
var method2 = union([
  literal("get"),
  literal("post"),
  literal("put"),
...
// deno:https://jsr.io/@skmtc/core/0.0.974/dsl/model/ModelDriver.ts
var ModelDriver2 = class {
  /** The generation context */
  context;
  /** The insertable model configuration */
  insertable;
  ...
  getDefinition({ identifier, exportPath }) {
    ...
    const definition = new Definition2({
      context: this.context,
      value,
      identifier,
      noExport: this.noExport
  ...
  affirmDefinition(definition, exportPath) {
    ...
    const currentKey = toModelGeneratorKey2({
      generatorId: this.insertable.id,
      refName: this.refName
    });
    if (currentKey !== definition.generatorKey) {
...
// deno:https://jsr.io/@skmtc/core/0.0.974/helpers/isEmpty.ts
var isEmpty2 = (value) => {
  return !Object.keys(value).length;
};

// deno:https://jsr.io/@skmtc/core/0.0.974/helpers/refFns.ts
var toRefName2 = ($ref) => {
  const refName = $ref.split("/").slice(-1)[0];
  if (!refName) {
    throw new Error("Invalid reference");
...
// deno:https://jsr.io/@skmtc/core/0.0.974/oas/array/array-types.ts
var oasArrayDataWithoutItems2 = object({
  type: literal("array"),
  title: optional(string()),
  description: optional(string()),
  default: optional(array(unknown())),
...
// deno:https://jsr.io/@skmtc/core/0.0.974/oas/integer/integer-types.ts
var integerSchema2 = pipe(number(), integer());
var integerFormat2 = union([
  literal("int32"),
  literal("int64")
]);
var oasIntegerData2 = object({
  type: literal("integer"),
  title: optional(string()),
  description: optional(string()),
  default: optional(integerSchema2),
  format: optional(integerFormat2),
  enum: optional(array(integerSchema2)),
  nullable: optional(boolean()),
  example: optional(integerSchema2),
  multipleOf: optional(integerSchema2),
  maximum: optional(integerSchema2),
  exclusiveMaximum: optional(boolean()),
  minimum: optional(integerSchema2),
  exclusiveMinimum: optional(boolean()),
  readOnly: optional(boolean()),
  writeOnly: optional(boolean()),
  deprecated: optional(boolean())
...
// deno:https://jsr.io/@skmtc/core/0.0.974/oas/number/number-types.ts
var numberFormat2 = union([
  literal("float"),
  literal("double")
]);
var oasNumberData2 = object({
  type: literal("number"),
  title: optional(string()),
  description: optional(string()),
  default: optional(number()),
  format: optional(numberFormat2),
  enum: optional(array(number())),
  nullable: optional(boolean()),
  example: optional(number()),
  multipleOf: optional(number()),
...
// deno:https://jsr.io/@skmtc/core/0.0.974/oas/boolean/boolean-types.ts
var oasBooleanData2 = object({
  type: literal("boolean"),
  title: optional(string()),
  description: optional(string()),
  default: optional(boolean()),
...
// deno:https://jsr.io/@skmtc/core/0.0.974/oas/string/string-types.ts
var stringFormat2 = enum_({
  "date-time": "date-time",
  time: "time",
  date: "date",
  duration: "duration",
...
// deno:https://jsr.io/@skmtc/core/0.0.974/oas/parameter/parameter-types.ts
var oasParameterLocation2 = enum_({
  query: "query",
  header: "header",
  path: "path",
  cookie: "cookie"
});
var oasParameterStyle2 = enum_({
  matrix: "matrix",
  label: "label",
  form: "form",
  simple: "simple",
...
// deno:https://jsr.io/@skmtc/core/0.0.974/oas/markdown/markdown-types.ts
var markdown2 = string();

// deno:https://jsr.io/@skmtc/core/0.0.974/oas/externalDocs/externalDocsTypes.ts
var oasExternalDocsData2 = object({
  description: optional(markdown2),
  url: string()
});

// deno:https://jsr.io/@skmtc/core/0.0.974/oas/securitySchemes/security-scheme-types.ts
var oasHttpSecuritySchemeData2 = object({
  type: literal("http"),
  description: optional(string()),
  scheme: string(),
  bearerFormat: optional(string())
});
var oasApiKeySecuritySchemeData2 = object({
  type: literal("apiKey"),
  description: optional(string()),
  name: string(),
  in: union([
...
var oasImplicitOAuth2FlowData2 = object({
  authorizationUrl: string(),
  refreshUrl: optional(string()),
  scopes: record(string(), string())
});
var oasAuthorizationCodeOAuth2FlowData2 = object({
  authorizationUrl: string(),
  tokenUrl: string(),
  refreshUrl: optional(string()),
  scopes: record(string(), string())
});
var oasClientCredentialsOAuth2FlowData2 = object({
  tokenUrl: string(),
  refreshUrl: optional(string()),
  scopes: record(string(), string())
});
var oasPasswordOAuth2FlowData2 = object({
  tokenUrl: string(),
  refreshUrl: optional(string()),
  scopes: record(string(), string())
});
var oasOAuth2FlowsData2 = object({
  authorizationCode: optional(oasAuthorizationCodeOAuth2FlowData2),
  clientCredentials: optional(oasClientCredentialsOAuth2FlowData2),
  implicit: optional(oasImplicitOAuth2FlowData2),
  password: optional(oasPasswordOAuth2FlowData2)
});
var oasOAuth2SecuritySchemeData2 = object({
  type: literal("oauth2"),
  description: optional(string()),
  flows: oasOAuth2FlowsData2
});
var oasOpenIdSecuritySchemeData2 = object({
  type: literal("openIdConnect"),
  description: optional(string()),
  openIdConnectUrl: string()
});
var oasSecuritySchemeData2 = union([
  oasHttpSecuritySchemeData2,
  oasApiKeySecuritySchemeData2,
  oasOAuth2SecuritySchemeData2,
  oasOpenIdSecuritySchemeData2
]);

// deno:https://jsr.io/@skmtc/core/0.0.974/dsl/EntityType.ts
var EntityType2 = class {
...
// deno:https://jsr.io/@skmtc/core/0.0.974/dsl/Identifier.ts
var Identifier2 = class _Identifier {
  /** The identifier name */
  name;
  ...
  static createVariable(name, typeName) {
    if (typeName) {
      return new _Identifier({
        name,
        typeName,
        entityType: new EntityType2("variable")
      });
    }
    return new _Identifier({
      name,
  ...
  static createType(name) {
    return new _Identifier({
      name,
      entityType: new EntityType2("type")
    });
  }
  /**
...
// deno:https://jsr.io/@skmtc/core/0.0.974/dsl/model/ModelBase.ts
var ModelBase2 = class extends ContentBase2 {
...
// deno:https://jsr.io/@skmtc/core/0.0.974/dsl/model/toModelBase.ts
var toModelBase = (config) => {
  return class extends ModelBase2 {
    static id = config.id;
    static type = "model";
    ...
    constructor(args) {
      super({
        ...args,
        generatorKey: toModelGeneratorKey2({
...
// deno:https://jsr.io/@skmtc/core/0.0.974/dsl/model/toModelEntry.ts
...
var camelCase2 = (str, { upperFirst, retainUnderscores } = {}) => {
  ...
  const camelCased = str.replace(delimiterPattern, (_2, matched) => {
    ...
    isFirstMatch = false;
    return capitalize2(matched);
  });
  const cleanPattern = retainUnderscores ? /[^a-zA-Z0-9_]/g : /[^a-zA-Z0-9]/g;
  const cleaned = camelCased.replace(cleanPattern, "");
  return upperFirst ? capitalize2(cleaned) : cleaned;
};

// deno:https://jsr.io/@skmtc/core/0.0.974/oas/contact/contact-types.ts
var oasContactData2 = object({
  oasType: literal("contact"),
  name: optional(string()),
  url: optional(string()),
  email: optional(string())
...
// deno:https://jsr.io/@skmtc/core/0.0.974/oas/discriminator/discriminator-types.ts
var oasDiscriminatorData2 = object({
  oasType: literal("discriminator"),
  propertyName: string(),
  mapping: optional(record(string(), string()))
});

// deno:https://jsr.io/@skmtc/core/0.0.974/oas/example/example-types.ts
var oasExampleData2 = object({
  oasType: literal("example"),
  summary: optional(string()),
  description: optional(markdown2),
  value: optional(unknown())
...
// deno:https://jsr.io/@skmtc/core/0.0.974/oas/license/license-types.ts
var oasLicenseData2 = object({
  oasType: literal("license"),
  name: string(),
  url: optional(string()),
  identifier: optional(string())
...
// deno:https://jsr.io/@skmtc/core/0.0.974/oas/info/info-types.ts
var oasInfoData2 = object({
  oasType: literal("info"),
  title: string(),
  description: optional(markdown2),
  termsOfService: optional(string()),
  contact: optional(oasContactData2),
  license: optional(oasLicenseData2),
  version: string()
});

// deno:https://jsr.io/@skmtc/core/0.0.974/oas/ref/ref-types.ts
var oasSchemaRefData2 = object({
  oasType: literal("ref"),
  refType: literal("schema"),
  $ref: string(),
  summary: optional(string()),
...
var oasResponseRefData2 = object({
  oasType: literal("ref"),
  refType: literal("response"),
  $ref: string(),
  summary: optional(string()),
...
var oasParameterRefData2 = object({
  oasType: literal("ref"),
  refType: literal("parameter"),
  $ref: string(),
  summary: optional(string()),
...
var oasRequestBodyRefData2 = object({
  oasType: literal("ref"),
  refType: literal("requestBody"),
  $ref: string(),
  summary: optional(string()),
...
var oasSecuritySchemeRefData2 = object({
  oasType: literal("ref"),
  refType: literal("securityScheme"),
  $ref: string()
});
var oasRefData2 = union([
  oasSchemaRefData2,
  oasResponseRefData2,
  oasParameterRefData2,
  oasExampleRefData2,
  oasRequestBodyRefData2,
  oasHeaderRefData2,
  oasSecuritySchemeRefData2
]);
...
// deno:https://jsr.io/@skmtc/core/0.0.974/oas/unknown/unknown-types.ts
var oasUnknownData2 = object({
  oasType: literal("schema"),
  title: optional(string()),
  description: optional(string()),
  default: optional(unknown()),
...
// deno:https://jsr.io/@skmtc/core/0.0.974/types/DenoJson.ts
var rootDenoJson2 = looseObject({
  imports: optional(record(string(), string())),
  exports: optional(record(string(), string())),
  workspace: optional(array(string()))
});
var packageDenoJson2 = looseObject({
  name: string(),
  version: string(),
  imports: optional(record(string(), string())),
  exports: union([
...
// deno:https://jsr.io/@skmtc/core/0.0.974/types/ModuleExport.ts
var moduleExport2 = object({
  exportName: string(),
  exportPath: string()
});

// deno:https://jsr.io/@skmtc/core/0.0.974/types/Enrichments.ts
var formFieldItem2 = object({
  id: string(),
  accessorPath: array(string()),
  input: moduleExport2,
  label: string(),
...
var formItem2 = object({
  title: optional(string()),
  description: optional(string()),
  fields: optional(array(formFieldItem2)),
  submitLabel: optional(string())
});
var tableColumnItem2 = object({
  id: string(),
  accessorPath: array(string()),
  formatter: moduleExport2,
  label: string()
});
var tableItem2 = object({
  title: optional(string()),
  description: optional(string()),
  columns: optional(array(tableColumnItem2))
});
var inputItem2 = object({
  id: string(),
  accessorPath: array(string()),
  formatter: moduleExport2
});
var operationEnrichments2 = object({
  table: optional(tableItem2),
  form: optional(formItem2),
  input: optional(inputItem2)
});
var methodEnrichments2 = record(string(), operationEnrichments2);
var pathEnrichments2 = record(string(), methodEnrichments2);
var generatorEnrichments2 = record(string(), pathEnrichments2);

// deno:https://jsr.io/@skmtc/core/0.0.974/types/Results.ts
var resultType2 = union([
  literal("success"),
  literal("warning"),
  literal("error"),
  literal("skipped"),
...
var resultsItem2 = record(string(), union([
  lazy(() => resultsItem2),
  resultType2,
  null_(),
  array(lazy(() => resultsItem2))
]));

// deno:https://jsr.io/@skmtc/core/0.0.974/types/Preview.ts
var operationSource2 = object({
  type: literal("operation"),
  generatorId: string(),
  operationPath: string(),
  operationMethod: method2
});
var modelSource2 = object({
  type: literal("model"),
  generatorId: string(),
  refName: string()
});
var previewGroup2 = picklist([
  "forms",
  "tables",
  "inputs"
]);
var previewModule2 = object({
  name: string(),
  exportPath: string(),
  group: previewGroup2
});
var mappingModule2 = object({
  name: string(),
  exportPath: string(),
  group: previewGroup2,
  itemType: picklist([
...
var source2 = variant("type", [
  operationSource2,
  modelSource2
]);
var preview2 = object({
  module: previewModule2,
  source: source2
});
var mapping2 = object({
  module: mappingModule2,
  source: source2
});

// deno:https://jsr.io/@skmtc/core/0.0.974/types/Manifest.ts
var manifestEntry2 = object({
  lines: number(),
  characters: number(),
  destinationPath: string()
});
var previewItem2 = object({
  name: string(),
  exportPath: string()
});
var manifestContent2 = object({
  deploymentId: string(),
  traceId: string(),
  spanId: string(),
  region: optional(string()),
  files: record(string(), manifestEntry2),
  previews: record(string(), record(string(), preview2)),
  mappings: optional(record(string(), record(string(), mapping2))),
  results: resultsItem2,
  startAt: number(),
  endAt: number()
});

// deno:https://jsr.io/@skmtc/core/0.0.974/types/PrettierConfig.ts
var prettierConfigType2 = object({
  printWidth: optional(number()),
  tabWidth: optional(number()),
  useTabs: optional(boolean()),
  semi: optional(boolean()),
...
// deno:https://jsr.io/@skmtc/core/0.0.974/types/Settings.ts
var modulePackage2 = object({
  rootPath: string(),
  moduleName: optional(string())
});
var skipPaths2 = record(string(), array(method2));
var skipOperations2 = record(string(), skipPaths2);
var skipModels2 = record(string(), array(string()));
var skip2 = union([
  skipOperations2,
  skipModels2,
  string()
]);
var clientSettings2 = object({
  basePath: optional(string()),
  schemaSource: optional(string()),
  packages: optional(array(modulePackage2)),
  enrichments: optional(generatorEnrichments2),
  skip: optional(array(skip2))
});
var skmtcClientConfig2 = object({
  serverUrl: optional(string()),
  projectKey: optional(string()),
  source: optional(string()),
...
// deno:https://jsr.io/@skmtc/core/0.0.974/typescript/FunctionParameter.ts
var import_helper_validator_identifier_7_275 = __toESM(require_lib());

// deno:https://jsr.io/@skmtc/core/0.0.974/typescript/identifiers.ts
...
var ZodString = class extends ContentBase2 {
  type = "string";
  format;
  enums;
  modifiers;
...
var ZodArray = class extends ContentBase2 {
  type = "array";
  items;
  modifiers;
...
var ZodBase = toModelBase({
  ...
  toIdentifier(refName) {
    const name = decapitalize(camelCase2(refName));
    return Identifier2.createVariable(name);
  },
  toExportPath() {
    return join3("@", "models.generated.ts");
  }
});
...
var ZodInsertable = class extends ZodBase {
  ...
  static createIdentifier = Identifier2.createVariable;
  toString() {
    return `${this.value}`;
  }
};
...
var ZodRef = class extends ContentBase2 {
  type = "ref";
  modifiers;
  name;
  terminal;
  constructor({ context, refName, destinationPath, modifiers, rootRef }) {
    ...
    if (context.modelDepth[`${zodEntry.id}:${refName}`] > 0) {
      ...
      const { settings } = new ModelDriver2({
        context,
        refName,
        destinationPath,
        rootRef,
...
var ZodUnknown = class extends ContentBase2 {
  type = "unknown";
...
var ZodObject = class extends ContentBase2 {
  type = "object";
  recordProperties;
  objectProperties;
  modifiers;
  constructor({ context, generatorKey, destinationPath, objectSchema, modifiers, rootRef }) {
    ...
    const hasProperties = properties && !isEmpty2(properties);
...
var ZodObjectProperties = class extends ContentBase2 {
  properties;
  required;
...
var ZodRecord = class extends ContentBase2 {
  value;
  constructor({ context, generatorKey, destinationPath, schema, rootRef }) {
    ...
    if (schema === true || isEmpty2(schema)) {
...
var ZodUnion = class extends ContentBase2 {
  type = "union";
  members;
  discriminator;
  modifiers;
...
var ZodNumber = class extends ContentBase2 {
  type = "number";
  modifiers;
...
var ZodInteger = class extends ContentBase2 {
  type = "integer";
  modifiers;
  format;
  enums;
  isNonNegative;
  title;
  constructor({ context, integerSchema: integerSchema3, modifiers, destinationPath, generatorKey }) {
    super({
      context,
      generatorKey
    });
    this.isNonNegative = Boolean(integerSchema3.minimum === 0 && integerSchema3.title);
    this.title = typeof integerSchema3 === "object" && "title" in integerSchema3 ? integerSchema3.title : void 0;
    this.format = integerSchema3.format;
    this.enums = integerSchema3.enums;
    this.modifiers = modifiers;
    context.register({
      imports: {
        zod: [
  ...
  toString() {
    ...
    let content;
    if (enums && Array.isArray(enums)) {
      content = enums.length === 1 ? `z.literal(${enums[0]})` : `z.union([${enums.map((e2) => `z.literal(${e2})`).join(", ")}])`;
    } else {
      content = this.isNonNegative ? `z.number().int().nonnegative("${this.title} must be non-negative")` : `z.number().int()`;
    }
    return applyModifiers(content, this.modifiers);
  }
};
...
var ZodBoolean = class extends ContentBase2 {
  type = "boolean";
  modifiers;
  constructor({ context, modifiers, destinationPath, generatorKey }) {
    super({
...
var ZodVoid = class extends ContentBase2 {
  type = "void";
...
// gen-typescript/src/withOptional.ts
var withOptional2 = (value, { required }) => {
  if (required) {
    return `${value}`;
  }
...
// gen-typescript/src/withNullable.ts
var withNullable2 = (value, { nullable }) => {
  return nullable ? `${value} | null` : `${value}`;
};

// gen-typescript/src/applyModifiers.ts
var applyModifiers2 = (content, modifiers) => {
  const postNullable = withNullable2(content, modifiers);
  const postOptional = withOptional2(postNullable, modifiers);
  return postOptional.toString();
};

// gen-typescript/src/TsString.ts
var TsString = class extends ContentBase2 {
  type = "string";
  format;
  enums;
  modifiers;
  constructor({ context, stringSchema, generatorKey, modifiers }) {
    super({
      context,
      generatorKey
    });
  ...
  toString() {
    ...
    const content = M({
      ...
      return matched.enums.length === 1 ? `'${matched.enums[0]}'` : `${matched.enums.map((str) => `'${str}'`).join(" | ")}`;
    }).otherwise(() => `string`);
    return applyModifiers2(content, this.modifiers);
  }
};

// gen-typescript/src/TsArray.ts
var TsArray = class extends ContentBase2 {
  type = "array";
  items;
  modifiers;
  constructor({ context, generatorKey, destinationPath, items, modifiers, rootRef }) {
  ...
  toString() {
    return applyModifiers2(`Array<${this.items}>`, this.modifiers);
  }
};

// gen-typescript/src/base.ts
var TypescriptBase = toModelBase({
  id: "@skmtc/gen-typescript",
  toIdentifier(refName) {
    const name = capitalize2(camelCase2(refName));
    return Identifier2.createType(name);
  },
  toExportPath() {
    return join3("@", "models.generated.ts");
  }
...
// gen-typescript/src/TsInsertable.ts
var TsInsertable = class extends TypescriptBase {
  value;
  constructor({ context, refName, settings, rootRef }) {
    super({
      context,
      refName,
      settings
  ...
  static createIdentifier = Identifier2.createType;
  toString() {
    return `${this.value}`;
  }
};

// gen-typescript/deno.json
var deno_default2 = {
...
var typescriptEntry = toModelEntry({
  id: deno_default2.name,
  transform({ context, refName }) {
    context.insertModel(TsInsertable, refName);
  }
});

// gen-typescript/src/TsRef.ts
var TsRef = class extends ContentBase2 {
  type = "ref";
  name;
  modifiers;
  terminal;
  constructor({ context, refName, modifiers, destinationPath, rootRef }) {
    super({
      context,
      generatorKey: toModelGeneratorKey2({
    ...
    if (context.modelDepth[`${typescriptEntry.id}:${refName}`] > 0) {
      ...
      const tsDriver = new ModelDriver2({
        context,
        refName,
        destinationPath,
        insertable: TsInsertable,
  ...
  toString() {
    return applyModifiers2(this.name, this.modifiers);
  }
};

// gen-typescript/src/TsUnknown.ts
var TsUnknown = class extends ContentBase2 {
  type = "unknown";
  constructor({ context, generatorKey }) {
    super({
      context,
...
// gen-typescript/src/TsObject.ts
var TsObject = class extends ContentBase2 {
  type = "object";
  recordProperties;
  objectProperties;
  modifiers;
  constructor({ context, generatorKey, destinationPath, value, modifiers, rootRef }) {
    super({
      context,
      generatorKey
    });
    ...
    const hasProperties = properties && !isEmpty2(properties);
    this.recordProperties = additionalProperties ? new TsRecord({
      context,
      generatorKey,
      destinationPath,
      schema: additionalProperties,
    ...
    this.objectProperties = hasProperties ? new TsObjectProperties({
      context,
      generatorKey,
      destinationPath,
      properties,
  ...
  toString() {
    const { objectProperties, recordProperties } = this;
    if (objectProperties && recordProperties) {
      return applyModifiers2(`${objectProperties} | ${recordProperties}`, this.modifiers);
    }
    return applyModifiers2(recordProperties?.toString() ?? objectProperties?.toString() ?? "Record<string, never>", this.modifiers);
  }
};
var TsObjectProperties = class extends ContentBase2 {
  properties;
  required;
  constructor({ context, generatorKey, destinationPath, properties, required = [], rootRef }) {
    super({
...
var TsRecord = class extends ContentBase2 {
  value;
  constructor({ context, generatorKey, destinationPath, schema, rootRef }) {
    super({
      context,
    ...
    this.value = M(schema).with(true, () => new TsUnknown({
      context,
      generatorKey
    })).with(z.when((schema2) => isEmpty2(schema2)), () => new TsUnknown({
      context,
      generatorKey
    })).otherwise((matched) => toTsValue({
      destinationPath,
      schema: matched,
      required: true,
      context,
...
// gen-typescript/src/TsUnion.ts
var TsUnion = class extends ContentBase2 {
  type = "union";
  members;
  discriminator;
  modifiers;
  ...
  toString() {
    const members = this.members.map((member) => `${member}`).join(" | ");
    return applyModifiers2(members, this.modifiers);
  }
};

// gen-typescript/src/TsNumber.ts
var TsNumber = class extends ContentBase2 {
  type = "number";
  modifiers;
  constructor({ context, modifiers, generatorKey }) {
    super({
      context,
      generatorKey
    });
  ...
  toString() {
    return applyModifiers2(`number`, this.modifiers);
  }
};

// gen-typescript/src/TsInteger.ts
var TsInteger = class extends ContentBase2 {
  type = "integer";
  modifiers;
  format;
  enums;
  constructor({ context, integerSchema: integerSchema3, generatorKey, modifiers }) {
    super({
      context,
      generatorKey
    });
  ...
  toString() {
    ...
    const content = M({
      ...
      enums: z.array()
    }, ({ enums: enums2 }) => enums2.join(" | ")).otherwise(() => `number`);
    return applyModifiers2(content, this.modifiers);
  }
};

// gen-typescript/src/TsBoolean.ts
var TsBoolean = class extends ContentBase2 {
  type = "boolean";
  modifiers;
  constructor({ context, modifiers, generatorKey }) {
    super({
  ...
  toString() {
    return applyModifiers2(`boolean`, this.modifiers);
  }
};

// gen-typescript/src/TsVoid.ts
var TsVoid = class extends ContentBase2 {
  type = "void";
  constructor({ context, generatorKey }) {
    super({
      context,
...
// gen-typescript/src/Ts.ts
var toTsValue = ({ schema, destinationPath, required, context, rootRef }) => {
  const modifiers = {
    required,
    // description: 'description' in schema ? schema.description : undefined,
    nullable: "nullable" in schema ? schema.nullable : void 0
  ...
  return M(schema).with({
    ...
    type: "integer"
  }, (integerSchema3) => new TsInteger({
    context,
    integerSchema: integerSchema3,
    modifiers,
    generatorKey
  })).with({
    type: "boolean"
